...
// NOTE: "Combat Legend" isn't in this list — it's awarded directly to
// whoever is ranked #1 overall (see LEGEND_TITLE below), regardless
// of point total.
const TITLES = [
...
// Special title always given to the #1 ranked player on the Overall
// leaderboard, overriding whatever their points would normally give them.
const LEGEND_TITLE = { label: 'Combat Legend', color: 'legend' };
